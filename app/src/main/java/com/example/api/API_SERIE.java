...
public class API_SERIE {
    ...
    public ArrayList<Serie> Search_Serie(String name, String lang, int page) throws Exception {
    ...
    public Serie findSerie(int id, String lang, @Nullable String append_to_response) throws IOException {
        Serie serie = null;
    ...
    public ArrayList<Serie> findSimilarSeries(int id, String lang, @Nullable String append_to_response) throws IOException {
        ArrayList<Serie> series = new ArrayList<>();
    ...
    public ArrayList<Serie> findRecommendationsSerie(int id, String lang, @Nullable String append_to_response) throws IOException {
        ArrayList<Serie> series = new ArrayList<>();
    ...
    public ArrayList<Review> GetSerieReviews(int id, String lang, @Nullable String append_to_response) throws IOException {
